...
class Database {
  ...
  set(key, value) {
    ...
    file[key] = value;
    autoBackup ? this.backupToFile() : null;
  ...
  info() {
    var info = {
      name: dbName,
      path: dbFile ?? "./databases/database.json",
  ...
  clear() {
    ...
    autoBackup ? this.backupToFile() : null;
    return this.saveToFile();
    console.log(clc.blue(`[${dbName}]: `) + clc.green("Database cleared!"));
  }
  /**
...
class DatabaseError extends Error {
  constructor(message) {
    super(clc.blue(`[${dbName}]: `) + clc.red(message));
  }
}
